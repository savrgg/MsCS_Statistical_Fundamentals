...
```{r 1, include=TRUE}
tabla_nber_th <- read_csv("tabla_nber_th.csv") #Importamos la tabla a analizar
...
# base de datos
data_ascor = read.csv("ascorbate.csv") #%>% 
...
```{r 4.1, include=TRUE}
places_raw <- read.csv("places.csv", row.names = 1, sep = "") %>% dplyr::select(Climate, HousingCost)
